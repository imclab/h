  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight._init = function(annotator) {
      ...
      annotator.addEvent(".annotator-hl", "mouseover", function(event) {
        return annotator.onAnchorMouseover(getAnnotations(event), TextHighlight.highlightType);
      });
      annotator.addEvent(".annotator-hl", "mouseout", function(event) {
        return annotator.onAnchorMouseout(getAnnotations(event), TextHighlight.highlightType);
      });
      annotator.addEvent(".annotator-hl", "mousedown", function(event) {
        return annotator.onAnchorMousedown(getAnnotations(event), TextHighlight.highlightType);
      });
      annotator.addEvent(".annotator-hl", "click", function(event) {
        return annotator.onAnchorClick(getAnnotations(event), TextHighlight.highlightType);
      });
    ...
    function TextHighlight(anchor, pageIndex, normedRange) {
      ...
      this.highlightType = 'TextHighlight';
