...
(function() {
  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight._init = function(annotator) {
      ...
      getAnnotations = function(event) {
        var annotations;
        return annotations = this.$(event.target).parents('.annotator-hl').andSelf().map(function() {
    ...
    function TextHighlight(anchor, pageIndex, realRange) {
  ...
  TextRangeAnchor = (function(_super) {
    ...
    TextRangeAnchor.prototype._createHighlight = function(page) {
      ...
      return new TextHighlight(this, page, range);
    };
