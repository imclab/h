...
// Generated by CoffeeScript 1.6.3
(function() {
  var $, Anchor, Annotator, Delegator, Highlight, LinkParser, Range, Util, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, simpleXPathJQuery, simpleXPathPure, util, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _ref1, _t,
    __slice = [].slice,
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.onSuccessfulSelection = function(event, immediate) {
      ...
      if (immediate) {
        return this.onAdderClick(event);
      } else {
    ...
    Annotator.prototype.onAnchorMouseover = function(annotations) {
    ...
    Annotator.prototype.onAnchorMouseout = function(annotations) {
      return this.startViewerHideTimer();
    };

    Annotator.prototype.onAnchorMousedown = function(annotations) {};

    Annotator.prototype.onAnchorClick = function(annotations) {};
