...
(function() {
  ...
  Anchor = (function() {
    ...
    Anchor.prototype.remove = function(removeFromAnnotation) {
      var anchors, i, index, _k, _ref1, _ref2, _ref3, _ref4;
      if (removeFromAnnotation == null) {
        removeFromAnnotation = false;
      }
      for (index = _k = _ref1 = this.startPage, _ref2 = this.endPage; _ref1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; index = _ref1 <= _ref2 ? ++_k : --_k) {
        ...
        if (!anchors.length) {
          delete this.annotator.anchors[index];
        }
      }
      if (removeFromAnnotation) {
        anchors = this.annotation.anchors;
        i = anchors.indexOf(this);
        return ([].splice.apply(anchors, [i, i - i + 1].concat(_ref4 = [])), _ref4);
      }
    };
  ...
  Annotator = (function(_super) {
    ...
    function Annotator(element, options) {
      this._reanchorAnnotations = __bind(this._reanchorAnnotations, this);
    ...
    Annotator.prototype.anchorAnnotation = function(annotation) {
    ...
    Annotator.prototype.deleteAnnotation = function(annotation) {
      ...
      if (annotation.anchors != null) {
        if (annotation.anchors.length) {
          ...
          if (i !== -1) {
            [].splice.apply(this.orphans, [i, i - i + 1].concat(_ref2 = [])), _ref2;
          }
        }
      }
    ...
    Annotator.prototype._reanchorAnnotations = function() {
      var anchor, anchors, annotation, annotations, page, _k, _l, _len2, _len3, _ref1, _ref2;
      console.log("Reanchoring all annotations.");
      annotations = this.orphans.slice();
      _ref1 = this.anchors;
      for (page in _ref1) {
        anchors = _ref1[page];
        _ref2 = anchors.slice();
      ...
      return this.publish("annotationsLoaded", [annotations.slice()]);
    };
